...
TriggerEvent('esx_society:registerSociety', 'cardealer', 'cardealer', 'society_cardealer', 'society_cardealer', 'society_cardealer', {type = 'public'})
...
AddEventHandler('eConcess:Ouvert', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'France Auto', '📢 ~b~Entreprise~s~ | ~m~Economique ', 'Le Concessionnaire est désormais ~g~Ouvert~s~ !', 'CHAR_CARDEALER', 8)
	end
end)
...
AddEventHandler('eConcess:Fermer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'France Auto', '📢 ~b~Entreprise~s~ | ~m~Economique ', 'Le Concessionnaire est désormais ~r~Fermer~s~ !', 'CHAR_CARDEALER', 8)
	end
end)
...
AddEventHandler('eConcess:Perso', function(msg)
    ...
    for i=1, #xPlayers, 1 do
        local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
        TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'France Auto', '📢 ~b~Entreprise~s~ | ~m~Economique ', msg, 'CHAR_CARDEALER', 8)
    end
end)
...
MySQL.Async.execute(
		...
		function(result)
			    TriggerClientEvent('esx:showAdvancedNotification', xPlayer.source, 'Clef', 'Concessionnaire', "Vous avez un nouvelle pair de clés !", 'CHAR_CARDEALER', 2)
			    TriggerClientEvent('esx:showAdvancedNotification', _source, 'Clef', 'Concessionnaire', "Clés bien enregistrer ! ", 'CHAR_CARDEALER', 2)
		end)
