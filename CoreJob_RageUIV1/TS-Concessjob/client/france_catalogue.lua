...
function CatalogueMenu()
	local catalogueee = RageUI.CreateMenu("", "© TS 2024")
	local vehiclemenu = RageUI.CreateSubMenu(catalogueee, "", "© TS 2024")
	local vehiclemenuparam = RageUI.CreateSubMenu(vehiclemenu, "", "© TS 2024")
	...
	vehiclemenuparam.Closed = function()
        ...
        while catalogueee do
            Citizen.Wait(0)
            RageUI.IsVisible(catalogueee, function()
